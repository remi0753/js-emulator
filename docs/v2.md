...
**Status:** Phase 1 done — the virtual hardware ([`src/v2/hw/`](../src/v2/hw/):
CPU privilege levels, paging MMU, traps, port I/O). The TS kernel
(`src/v2/kernel/`) and userland are in progress. For the predecessor see
[v1.md](v1.md).
